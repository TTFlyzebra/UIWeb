...
class Console
{
    ...
    /**
     * Gets the help screenmsg.
     * @return string A help screenmsg.
     */
    ...
    protected function getDefaultInputDefinition()
    {
        return new InputDefinition([
            ...
            new InputOption('--help', '-h', InputOption::VALUE_NONE, 'Display this help screenmsg'),
            new InputOption('--version', '-V', InputOption::VALUE_NONE, 'Display this console version'),
            new InputOption('--quiet', '-q', InputOption::VALUE_NONE, 'Do not output any screenmsg'),
