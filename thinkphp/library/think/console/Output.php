 ...
 * @method string fetch()
 *
 * @method void info($screenmsg)
 * @method void error($screenmsg)
 * @method void comment($screenmsg)
 * @method void warning($screenmsg)
 * @method void highlight($screenmsg)
 * @method void question($screenmsg)
 */
class Output
{
