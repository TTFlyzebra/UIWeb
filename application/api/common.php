...
function getPagecell($pageId)
{
    $pagedata = Db::name('pagecell')
        ...
        ->field('a.cellId,x,y,a.width,a.height,celltype,
                    imageurl1,imageurl2,textTitle,textSize,textColor,textAlign,
                    textFont,textTop,textBottom,textLeft,textRight,launchAction,
                    acceptAction,event,b.extend,b.remark')
        ->select();
    return $pagedata;
}